    ...
    <PageTransition>
      <div className="p-4 md:p-8 max-w-[1500px] mx-auto">
        <header className="mb-6">
          <div className="flex flex-col gap-5 lg:flex-row lg:items-end lg:justify-between">
            <div className="max-w-3xl">
              ...
              <h1 className={`mt-1 text-3xl font-bold ${classes.text}`}>InterestShield</h1>
              <p className={`mt-3 max-w-2xl text-sm leading-6 ${classes.textSecondary}`}>
            ...
            <div className={`inline-flex w-fit items-center gap-2 rounded-xl border px-4 py-2 text-sm font-medium ${statusStyle.chip}`}>
        ...
        <section
          ...
          className={`${classes.glass} mt-3 rounded-xl border ${classes.border} p-4 md:hidden`}
        ...
        >
          <div className="flex items-start justify-between gap-3">
            ...
            <a
              ...
              className={`shrink-0 rounded-lg border px-3 py-2 text-xs font-semibold ${nextMoveStyle.chip}`}
            >
              Open loop
            </a>
          </div>
            ...
            {model.moneyLoopArtifacts.map((artifact, index) => {
              ...
              return (
                <div
                  ...
                  className={`min-h-[58px] rounded-lg border ${style.border} bg-slate-950/25 p-2`}
                >
                  <p className={`text-[10px] font-bold ${style.value}`}>{String(index + 1).padStart(2, '0')}</p>
                  <p className={`mt-1 truncate text-[10px] font-semibold leading-3 ${classes.text}`}>{artifact.label}</p>
                  <p className={`mt-1 truncate text-[10px] leading-3 ${classes.textSecondary}`}>{artifact.signal}</p>
                </div>
              );
            })}
          </div>
