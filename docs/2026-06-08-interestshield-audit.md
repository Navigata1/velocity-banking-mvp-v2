...
- Add math tests. Status: broad route and engine regression coverage exists; Repair Pass 201 added a direct Portfolio simulation corruption fixture, Repair Pass 202 added a current-balance percent-minimum fixture, Repair Pass 203 added a direct multi-debt corruption fixture, Repair Pass 204 adds live store setter corruption fixtures, and Repair Pass 205 adds Vault strategy label corruption fixtures.
- Fix invalid/negative cash-flow handling. Status: expanded across Dashboard, Simulator, Vault, mobile snapshots, Portfolio, and multi-debt simulation; Repair Pass 201 hardens Portfolio against non-finite/corrupt inputs before cash-flow and payoff math, Repair Pass 203 does the same for web multi-debt payoff math, Repair Pass 204 closes live store setter paths before bad values reach payoff helpers, and Repair Pass 205 keeps Vault labels from trusting corrupt payoff flags.
