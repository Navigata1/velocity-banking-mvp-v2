...
- Add math tests. Status: broad route and engine regression coverage exists; Repair Pass 201 added a direct Portfolio simulation corruption fixture, and Repair Pass 202 added a current-balance percent-minimum fixture.
